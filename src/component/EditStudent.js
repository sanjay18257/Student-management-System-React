...
const EditStudent = (props) => {
    ...
    const { id } = useParams();
    const [fname, setFname] = useState(props.students[id].fname);
    const [lname, setLname] = useState(props.students[id].lname);
    const [phone, setPhone] = useState(props.students[id].phone);
    const [address, setAddress] = useState(props.students[id].address);
    const [email, setEmail] = useState(props.students[id].email);
    const [age, setAge] = useState(props.students[id].age);
